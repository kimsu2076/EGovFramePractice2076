...
CREATE MEMORY TABLE TBL_USER(USER_ID VARCHAR(50) NOT NULL PRIMARY KEY,USER_NAME VARCHAR(100),PASSWORD VARCHAR(100))
CREATE MEMORY TABLE TBL_BOARD(IDX INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY,TITLE VARCHAR(200),CONTENTS VARCHAR(4000),"COUNT" INTEGER DEFAULT 0,WRITER VARCHAR(50),INDATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP)
CREATE MEMORY TABLE TBL_REPLY(REPLY_IDX INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY,IDX INTEGER,CONTENTS VARCHAR(2000),WRITER VARCHAR(50),INDATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP)

INSERT INTO TBL_USER VALUES('admin','관리자','1234')
INSERT INTO TBL_USER VALUES('guest','사용자','1234')

INSERT INTO TBL_BOARD (TITLE,CONTENTS,"COUNT",WRITER,INDATE) VALUES('안녕하세요. 게시판공지 입니다','공지사항 내용입니다.',1,'admin',CURRENT_TIMESTAMP)
