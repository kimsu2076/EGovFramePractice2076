			...
			<div class="container my-4">
				...
				<div class="card-header">
					<form class="row g-3" action="/mainList.do">
						<div class="col-md-4">
							<label for="id" class="form-label">아이디</label> <input type="text" class="form-control"
								id="id" name="id">
						</div>
						<div class="col-md-4">
				...
				<div class="card-body">
					<form class="row g-3 mb-4" action="/search.do">
						<div class="col-md-6">
							<label for="searchName" class="form-label">제목</label> <input type="text"
						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach var="result" items="${resultList}" varStatus="status">
									<tr>
										<td><a href="javascript:view('${result.idx}');">
